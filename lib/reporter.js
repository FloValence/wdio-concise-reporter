...
class ConciseReporter extends events.EventEmitter {
  ...
  prepareConsole(jsonReport) {
    let mainMessage = `${jsonReport.capabilities.browserName}:\
${jsonReport.capabilities.browser_version}::${jsonReport.capabilities.os}:\
${jsonReport.capabilities.os_version && 'latest'}::${jsonReport.capabilities.resolution}\n`
